...
export async function createDefaultSections(pageId: string) {
  const defaults = [
    ...
    },
    {
      ...
      config: {
        eyebrow: "Features",
        title: "Everything needed to launch faster",
        subtitle: "Reusable blocks, live preview and database-backed editing.",
    ...
    },
    {
      ...
      config: {
        ...
        subtitle: "Connect with the business instantly.",
  ...
  const defaultConfig =
    type === "hero"
      ...
      ? {
          ...
          subtitle: "Explain what makes this business different.",
