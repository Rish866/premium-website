    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 text-white">
      ...
      <div className="relative w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-2xl">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Login to AgencyOS</h1>
            <p className="text-sm text-white/45">Continue to your workspace</p>
          </div>
        </div>
        ...
        <button onClick={login} className="w-full rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-black">
          Login
        </button>
        ...
        <p className="mt-5 text-center text-sm text-white/45">
          No account? <Link to="/signup" className="text-cyan-200">Create one</Link>
        </p>
      </div>
    </main>
  );
